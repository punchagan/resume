...
%---------------------------------------------------------
  \cventry
      ...
      {Sep. 2016 - Present} % Date(s)
      {
        ...
        \techstack{Python, Django, Postgres, React, Clojure, Docker, Kubernetes, Git}
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \techstack{Lua, Torch, Python, Django, Flask, Postgres, AWS, Git}
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \techstack{Python, PySide (PyQt), Enthought Tool Suite, Javascript, IPython, Numpy, Pandas, Git}
